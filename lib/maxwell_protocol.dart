...
extension ref_aware_on_add_route_msg_t on add_route_msg_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_add_route_req_t on add_route_req_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_auth_req_t on auth_req_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_delete_route_rep_t on delete_route_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_delete_topics_rep_t on delete_topics_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_do2_rep_t on do2_rep_t {
  int get_ref() {
...
extension ref_aware_on_do_rep_t on do_rep_t {
  int get_ref() {
    return this.traces[0].ref;
  }
}
...
extension ref_aware_on_error2_rep_t on error2_rep_t {
  int get_ref() {
    return this.traces[0].ref;
  }
}
...
extension ref_aware_on_ok2_rep_t on ok2_rep_t {
  int get_ref() {
    return this.traces[0].ref;
  }
}
...
extension ref_aware_on_ping_rep_t on ping_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_pull_rep_t on pull_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_pull_routes_rep_t on pull_routes_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_push_rep_t on push_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_push_routes_rep_t on push_routes_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_register_backend_rep_t on register_backend_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_register_frontend_rep_t on register_frontend_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_resolve_backend_rep_t on resolve_backend_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_resolve_frontend_rep_t on resolve_frontend_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_resolve_ip_rep_t on resolve_ip_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_unwatch_rep_t on unwatch_rep_t {
  int get_ref() {
    return this.ref;
  }
}
...
extension ref_aware_on_watch_rep_t on watch_rep_t {
  int get_ref() {
    return this.ref;
  }
}
